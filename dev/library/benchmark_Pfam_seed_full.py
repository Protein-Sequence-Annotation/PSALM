...
train_db = "/n/eddy_lab/Lab/protein_annotation_dl/PSALM/dev/data/train_test_splitting/Pfam_A.seed.full.train.fasta"
test_db = "/n/eddy_lab/Lab/protein_annotation_dl/PSALM/dev/data/train_test_splitting/Pfam_A.seed.full.test.fasta"

# Parse the train/test db FASTA files into lists of SeqRecord objects
train_records = list(SeqIO.parse(train_db, 'fasta'))
test_records = list(SeqIO.parse(test_db, 'fasta'))

# pdb.set_trace()

# save_path = "/n/eddy_lab/Lab/protein_annotation_dl/PSALM/data/benchmarking"
save_path = "/n/eddy_lab/Lab/protein_annotation_dl/PSALM/dev/data/train_test_splitting"
