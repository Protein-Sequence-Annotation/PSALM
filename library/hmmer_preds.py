...
def shard_predict_clan(shard, target_path, pred_path, maps):
    ...
    for label in target_dict.keys():
        ...
        _, target_vector = hu.generate_domain_position_list2(target_dict, label, maps)
        _, pred_vector = hu.generate_domain_position_list2(pred_dict, label, maps) # Account for no hits
        ...
        shard_preds[label]['clan_top'] = (top_total / fams.shape[0])
