...
def train_parser():
    ...
    parser.add_argument('-s', '--seed', action='store_false', default=True, help='set seed for reproducibility')
    parser.add_argument('-l', '--log', action='store_false', default=True, help='log to wandb')
    parser.add_argument('-rt', '--root', type=str, default='../dev/data/full_data_curation', help='path to data folder')
    parser.add_argument('-x', '--suffix', type=str, default='', help='suffix to use for train dataset')
    parser.add_argument('-v', '--validation', action='store_false', default=True, help='compute validation loss')
